...
<table width="750" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
    	<td colspan="5" height="50" bgcolor="#CCCCFF"><div align="center" class="style1"><h3>删除书籍</h3></div></td>
  </tr>
  <tr>
        <td width="221" height="30" bgcolor="#FFFFFF"><div align="center"><font color="3333333">书名</font></div></td>
...
?>
 	...
 	<tr>
		...
		<td  align="center"><font color="#cc6600"><?php echo $myrow[7]?></font></td>
 		<td  align="center"><font color="#cc6600"><?php echo '<a href="doDeletepdf.php?action=delete&ID='.$myrow[7].'">点击删除</a>';?>
 		</font></td>
 	</tr>
